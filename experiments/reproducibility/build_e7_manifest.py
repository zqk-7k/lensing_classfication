...
DATA = ROOT / "data"
PAIR_DIR = ROOT / "experiments/reproducibility/manifests/0228_pairs"
OUT = ROOT / "experiments/reproducibility/manifests/e7_typeii"
SEED = 20260711
...
def main():
    ...
    contract = {
        ...
        "model": "frozen frozen v1 PI-ResNet checkpoint for each lens family",

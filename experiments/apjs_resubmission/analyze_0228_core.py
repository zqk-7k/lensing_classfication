#!/usr/bin/env python3
"""Freeze unified predictions and run the locked APJS 0228 core analysis."""
...
def parse_args():
    ...
    parser.add_argument("--prediction-dir", default=str(ROOT / "runs/apjs_resubmission_final_v1/predictions_0228"))
    parser.add_argument("--manifest-dir", default=str(ROOT / "experiments/apjs_resubmission/manifests/0228_pairs"))
    parser.add_argument("--output-dir", default=str(ROOT / "runs/apjs_resubmission_final_v1/core_analysis_0228"))
...
def main():
    ...
    for lens in ("sis", "pm"):
        ...
        thresholds = {model: {fpp: float(np.quantile(cal.loc[cal.label == 0, score], 1 - fpp, method="higher"))

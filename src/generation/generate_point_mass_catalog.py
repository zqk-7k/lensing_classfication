#!/usr/bin/env python3
"""Generate point-mass lensed gravitational-wave simulation catalogs."""
...
SAVE_DIR = os.environ.get("GW_PM_DATA_DIR", str(PROJECT_ROOT / "data" / "ligo_full" / "PM_data"))
...
ms=const.M_sun.to(units.kg).value  # implementation detail

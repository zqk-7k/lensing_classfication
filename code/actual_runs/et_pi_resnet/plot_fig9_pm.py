...
def plot_pm_log_roc():
    ...
    # 这里已经把标题改干净了
    plt.title('Log-ROC Sensitivity: PM')
    plt.legend(loc='lower right', frameon=True, edgecolor='black')

    os.makedirs('pic', exist_ok=True)
    plt.tight_layout()
    plt.savefig('pic/fig9_pm_new_large.png', dpi=300)
    print("✅ PM 绘图大功告成！已保存至: pic/fig9_pm_new_large.png")

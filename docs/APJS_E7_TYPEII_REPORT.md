...
Does the frozen final-v1 PI-ResNet score respond measurably to the type-II geometric-optics phase intervention when source parameters, magnification, stored noise realization, and peak-aligned arrival are held fixed?
